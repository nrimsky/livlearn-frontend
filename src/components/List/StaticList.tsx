  ...
  return (
    <div className="sm:m-5 my-5">
      <div className="mx-5 sm:mx-0 w-100">
        <p className="mb-3 px-2 w-full text-gray-900 font-medium no-round leading-snug">
          {resourceList.title}
        </p>
      </div>
      <ul className="sm:rounded border border-gray-300 divide-y divide-gray-200">
        {resourceList.data.map((d, i) => {
          return <li
            className="pl-3 pr-4 py-3 bg-white grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-3 leading-snug"
            key={i}
          >
